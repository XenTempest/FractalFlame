...
function choose(functions, probs) {
    const r = Math.random();
    let sum = 0;
 ...
 */
function matrixFn(matrix) {
    return (vector) => matrix.times(vector);
}
/**
 ...
 */
function normalizeDistribution(probs) {
    let sum = 0;
 ...
 */
function syncKeys(keys, map, random) {
